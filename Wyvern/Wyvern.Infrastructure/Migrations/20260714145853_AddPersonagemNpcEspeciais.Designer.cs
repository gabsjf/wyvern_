...
namespace Wyvern.Infrastructure.Migrations
{
    ...
    [Migration("20260714145853_AddPersonagemNpcEspeciais")]
    partial class AddPersonagemNpcEspeciais
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Wyvern.Domain.Entities.PersonagemNpc", b =>
                {
                    ...
                    b.Property<string>("ClasseArmaduraOrigem")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DeslocamentoDescricao")
                        .HasColumnType("nvarchar(max)");
